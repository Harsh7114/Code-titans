...
def build_sample_sos_dataframe() -> pd.DataFrame:
    return pd.DataFrame(
        [
            {
                "id": "sos-001",
                "message_text": "Massive building collapse near Connaught Place. Multiple people trapped under rubble, need immediate medical assistance.",
                "source": "sms",
            ...
            {
                "id": "sos-002",
                "message_text": "Road totally blocked by debris in Karol Bagh. We are safe but running out of drinking water for 15 people.",
                "source": "app",
                "timestamp": "2026-04-24T12:21:00+05:30",
                "priority": "medium",
                "location_text": "Karol Bagh, New Delhi",
            },
            {
                "id": "sos-003",
                "message_text": "Severe structural damage to apartment complex in Vasant Kunj. 3 elderly citizens injured and bleeding.",
                "source": "sms",
                "timestamp": "2026-04-24T12:32:00+05:30",
                "priority": "high",
                "location_text": "Vasant Kunj, New Delhi",
            },
            {
                "id": "sos-004",
                "message_text": "Market area roof caved in at Chandni Chowk. Suspect 5 people are stuck inside the back shops.",
                "source": "twitter",
                "timestamp": "2026-04-24T12:45:00+05:30",
                "priority": "high",
                "location_text": "Chandni Chowk, New Delhi",
            },
            {
                "id": "sos-005",
                "message_text": "Powerlines down and minor structural cracks in Lajpat Nagar. No injuries yet, request emergency cots.",
                "source": "sms",
                "timestamp": "2026-04-24T13:05:00+05:30",
                "priority": "low",
                "location_text": "Lajpat Nagar, New Delhi",
            },
        ]
    )
